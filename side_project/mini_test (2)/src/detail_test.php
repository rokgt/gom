...
define("SIDE_BAR",ROOT."sidebar.php");
...
<?php 
	...
	<section>
		<a href="/mini_test/src/update_test.php/?id=<?php echo $id;?>&page=<?php echo $page;?>">수정</a>
		<a href="/mini_test/src/list_test.php/?page=<?php echo $page;?>">취소</a>
		<a href="/mini_test/src/delete_test.php/?id=<?php echo $id;?>">삭제</a>
	</section>
</body>
</html>